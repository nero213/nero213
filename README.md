<!-- ROBE KYLE P. SALANGAD — GITHUB PROFILE README -->

<div align="center">
  <img width="100%" src="https://capsule-render.vercel.app/api?type=waving&color=0:080808,60:0d0d0d,100:00d4ff&height=200&section=header&text=ROBE%20KYLE%20P.%20SALANGAD&fontSize=36&fontColor=ffffff&animation=fadeIn&fontAlignY=42&desc=Full-Stack%20Web%20Developer&descAlignY=62&descColor=00D4FF&descSize=17" alt="Robe Kyle P. Salangad — Full-Stack Web Developer" />
</div>
...
<div align="center">
  <a href="https://robekyle-portfolio.pages.dev">
    <img src="https://img.shields.io/badge/Portfolio-050505?style=for-the-badge&logo=googlechrome&logoColor=00D4FF" alt="Portfolio" />
  </a>
  &nbsp;
  ...
  &nbsp;
  <img src="https://komarev.com/ghpvc/?username=nero213&color=00d4ff&style=for-the-badge&label=PROFILE+VIEWS" alt="Profile Views" />
</div>
...
I'm a full-stack web developer focused on building practical, complete applications — from the interface a user sees to the systems running underneath.

I enjoy taking a problem, designing a solution, and building it end-to-end: clean frontends, reliable backend APIs, structured databases, and smooth deployment. I also work with AI tools and LLM APIs to add intelligent capabilities where they genuinely add value.
...
```
01  WEB APPLICATIONS
    Modern, responsive websites and web apps built around real users.
    From landing pages to full product interfaces.

02  BACKEND & API SYSTEMS
    Server-side logic, REST APIs, authentication, and business workflows.
    Systems that handle data reliably and securely.

03  DATABASE SOLUTIONS
    Structured relational databases designed for real-world use.
    MySQL, PostgreSQL, TiDB — schema design, queries, relationships.

04  AI INTEGRATIONS
    LLM-powered features, intelligent workflows, and automation.
    Practical AI that solves problems rather than just looking impressive.

05  FULL-STACK PRODUCTS
    End-to-end applications built from the ground up.
    Frontend to backend. Idea to deployment.
```
...
![TiDB](https://img.shields.io/badge/TiDB-CC0200?style=flat-square&logo=pingcap&logoColor=white)

**AI & Automation**&nbsp;
![OpenAI](https://img.shields.io/badge/OpenAI%20API-412991?style=flat-square&logo=openai&logoColor=white)
![LangChain](https://img.shields.io/badge/LangChain-1C3C3C?style=flat-square&logo=langchain&logoColor=white)
![RAG](https://img.shields.io/badge/RAG%20Pipelines-00d4ff?style=flat-square&logo=databricks&logoColor=white)
...
Exploring  →  LLM agents, RAG pipelines, prompt engineering
Available  →  Freelance projects and open collaboration
```
...
<div align="center">
  <img width="100%" src="https://capsule-render.vercel.app/api?type=waving&color=0:00d4ff,100:080808&height=100&section=footer" alt="footer" />
</div>
